...
public class GodPowerController extends ControllerState {
    ...
    public GodPowerController(Controller mainController, Game currentGame) {
        ...
        choosingPlayerIndex = SECOND_ELEMENT_INDEX;
        //The player selecting the first godPower is always the second to join the game
    }

    /**
     * This is the specific handle function used to handle the event generated by the player selecting the god they'll use in their game
     * @param event The godSelectionEvent
     * @param senderView The view which event belongs to
     */
