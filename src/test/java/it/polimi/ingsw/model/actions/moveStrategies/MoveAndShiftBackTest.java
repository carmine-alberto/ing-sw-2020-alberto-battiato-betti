...
class MoveAndShiftBackTest {
    ...
    void setUp() {
        ...
        game.assignSelectedGodPowerToPlayer("Minotaur", firstPlayer);
        game.assignSelectedGodPowerToPlayer("Apollo" , secondPlayer);
    ...
    void test(){
        ...
        assertEquals(board[1][2] , secondWorker.getCell());
